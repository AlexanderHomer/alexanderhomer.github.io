...
* Recall that we have two components to our immune system:
  ...
  * Humoral Immune System
    * B Cells (CD20)
* Also Recall that:
  * IL-4 activatews B Cells to produce IgE
...
* Antibodies
  ...
  * IgM
  * IgA
  * IgE - binds mast cells (release histamine) and basophils
* Types of Immune respons
  * Type I (we will focus on today, hyperacute)
  * Type II - humoral
  * Type III - Immune complex
  * Tpye IV - delayed hypersensitivity

## Oral Allergy Syndrome
  * Birch -> apple, nutes, apricot, peach
  * Grass -> tomato, oranges
  * Ragweed -> bananas
  * Latex -> bananas, kiwis, avocados
  * Shellfish -> dust mites
...
- **Skin Prick Test (SPT)**
  - **Description:** A small amount of allergen extract is placed on the skin, usually forearm or back, and the skin is lightly pricked.
  - **Time to results:** 15–20 minutes.
  - **Positive result:** A wheal (raised bump) with surrounding erythema.
  - **Advantages:** Simple, rapid, cost-effective, sensitive.
  - **Limitations:** Affected by antihistamines, dermatographism, and skin conditions like eczema.

- **Intradermal Testing**
  - **Description:** Small amount of allergen injected intradermally.
  - **More sensitive** than prick testing but less specific.
...
- Asthma evaluation.
- Atopic dermatitis with suspected triggers.
